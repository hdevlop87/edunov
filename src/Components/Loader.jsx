...
const Preloader = () => {
    return (
        <div className="flex justify-center items-center h-screen bg-purple-100">
            <svg id="preloader" fill='none' stroke='#FDB515' width="240px" height="120px" viewBox="0 0 240 120" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" className="text-yellow-500 fill-current">
                <style>
                    {`
          #loop-normal {
            stroke-width: 12;
        ...
        `}
                ...
                <path id="loop-normal" fill='none' d="M120.5,60.5L146.48,87.02c14.64,14.64,38.39,14.65,53.03,0s14.64-38.39,0-53.03s-38.39-14.65-53.03,0L120.5,60.5
